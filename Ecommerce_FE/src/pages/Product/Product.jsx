  ...
  return (
    <div>
      <Link
        ...
        className="w-[320px] h-[360px] bg-gray-100 rounded-lg overflow-hidden flex flex-col hover:bg-gray-200 hover:shadow-md hover:w-[330px] hover:h-[370px] transition-all duration-300 ease-in-out"
      >
